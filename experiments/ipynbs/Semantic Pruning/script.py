...
variables = {
    "method": [
        'Prune by CI(feedforward only), Head Pruning with Generated samples',
        'Prune by CI(feedforward only, squeeze), Head Pruning with Generated samples',
        'Prune by CI(feedforward only, squeeze) with Generated samples',
        'Prune by CI(feedforward only, structed) with Generated samples',
        'Prune by CI(feedforward only) with Generated samples',
